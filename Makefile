...
TMP_GIT_DIR = /tmp/lfe-rebar3-command-reference-git
...
$(PUBLISH_DIR)/README.md:
	@echo '# Content for The LFE rebar3 Plugin Command Reference' > $(PUBLISH_DIR)/README.md
	@echo 'Published at [lfe.io/reference/lfe-rebar3/](https://lfe.io/reference/lfe-rebar3/)' >> $(PUBLISH_DIR)/README.md
